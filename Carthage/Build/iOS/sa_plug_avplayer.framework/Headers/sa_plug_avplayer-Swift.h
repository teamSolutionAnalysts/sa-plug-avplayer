...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="sa_plug_avplayer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16sa_plug_avplayer12BufferSlider")
...
SWIFT_CLASS("_TtC16sa_plug_avplayer8DemoData")
...
SWIFT_CLASS("_TtC16sa_plug_avplayer19VideoControllButton")
...
SWIFT_CLASS("_TtC16sa_plug_avplayer18VideoControllLabel")
...
SWIFT_CLASS("_TtC16sa_plug_avplayer15VideoController")
...
SWIFT_CLASS("_TtC16sa_plug_avplayer9ViewVideo")
...
@interface ViewVideo (SWIFT_EXTENSION(sa_plug_avplayer)) <AVAssetResourceLoaderDelegate, WKNavigationDelegate>
